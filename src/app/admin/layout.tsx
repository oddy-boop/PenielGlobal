...
import { Video, Calendar, Image as ImageIcon, LogOut, LayoutDashboard, Laptop, Home, MessageSquare, Phone, DollarSign, Shield, Church } from 'lucide-react';
...
const adminNavLinks = [
  ...
  { href: '/admin/services', label: 'Services', icon: Church },
